"""
Shared helpers for talking to a local llama.cpp server with image input,
used by ask_image.py and compare_images.py.
"""
...
def encode_image(path: str) -> str:
    """Return a data: URI for the image at `path`, for use in image_url content parts."""
